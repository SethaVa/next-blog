    ...
    <>
      ...
      >
        ...
        >
          <Link
            ...
            href={`/post/${pathPrefix ? `${pathPrefix}/` : ""}${post.id}`}
          >
            {post?.featuredImage?.url ? (
              <img
                alt={post.title}
                src={post.featuredImage.url}
                className="object-top absolute h-80 w-full object-cover transition-all"
                fill
      ...
      dark:from-purple-800 dark:to-purple-900"
            ...
            <div className="hidden">
              {post.excerpt && <EditorTextParser data={post.excerpt} />}
            </div>
