...
const PostCard = ({post}) => {
    return (
        <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
            ...
            <h1 className="transition duration-700 text-center mb-6 cursor-pointer hover:text-pink-600 font-semibold text-3xl">
                <Link href={`/post/${post.slug}`}>
                    {post.title}
                </Link>
            </h1>
            <div className="blog lg:flex w-full items-center justify-center mb-6 text-center gap-12">
                <div className="flex items-center justify-center mb-4 w-full lg:w-auto lg:mb-0">
                    <img
                        alt={post.title}
                        width={30}
                        height={30}
